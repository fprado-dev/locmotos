...
import { RenterIncidents } from "../incidents-block";
        ...
        {editando ? (
          ...
          <>
            <div className="flex min-h-0 flex-1 flex-col gap-[22px] overflow-y-auto px-6 pt-5 pb-6">
              ...
              {/* Depois das infrações: multa é dinheiro, sinistro é confiança
                  — e a segunda pergunta só se faz depois da primeira. */}
              <RenterIncidents incidents={incidents} />
