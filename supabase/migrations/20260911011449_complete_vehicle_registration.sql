...
--
-- Tudo aqui é opcional: o gestor cadastra o veículo com o que tem à mão e
...
alter table public.vehicles
  ...
  add column licensing_due_date date,       -- vencimento do licenciamento
  add column fipe_value numeric(10, 2),
  add column weekly_price numeric(10, 2),   -- valor semanal, registrado e não calculado
...
--
-- `upper(btrim())` porque a placa é a mesma escrita em qualquer caixa e com
-- qualquer sobra de espaço — e assim a garantia vale mesmo para quem escreve
-- no banco sem passar pela aplicação.
